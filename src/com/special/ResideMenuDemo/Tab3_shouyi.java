...
public class Tab3_shouyi extends WindowActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tab3_shouyi);
	...
	public void setClass(){
		...
		if(TimeActivity.curDay<6&&TimeActivity.curDay>0){
			...
			for(int i=0;i<GlobeEmptyClassroom.resultOfEmptyClassrooms.size();i++){
				...
				if(temp.charAt(4)=='瀚') {wenTai[t]=new String(temp.substring(5));wenTaiMode[t]=tempMode;t++;}
				else continue;
			}

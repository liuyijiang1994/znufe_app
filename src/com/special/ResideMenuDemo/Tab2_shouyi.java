...
public class Tab2_shouyi extends WindowActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tab2_shouyi);
	...
	System.out.println(infoBeans.size());
		...
		if(TimeActivity.curDay<6&&TimeActivity.curDay>0){
			...
			for(int i=0;i<GlobeEmptyClassroom.resultOfEmptyClassrooms.size();i++){
				...
				if(temp.charAt(4)=='润') {wenLan[l]=new String(temp.substring(5));wenLanMode[l]=tempMode;l++;}
				else continue;
			}

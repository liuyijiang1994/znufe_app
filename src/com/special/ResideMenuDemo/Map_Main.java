...
public class Map_Main extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//将listview改成button(button1代表首义校区，button2代表南湖校区)
		btn1.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent shouyi = new Intent(Map_Main.this, ShouYi.class);
				startActivity(shouyi);
				//finish();
			}
			}
		 );
		...
		btn2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				 //TODO Auto-generated method stub
				Intent shouyi = new Intent(Map_Main.this, NanHu.class);
				startActivity(shouyi);
				//finish();
			}
			}
	...
	/*void onListItemClick(int index) {
		Intent intent = null;
		intent = new Intent(Map_Main.this, demos[index].demoClass);
	...
	//private static final DemoInfo[] demos = {
			...
			//		R.string.demo_desc_overlay, NanHu.class),
			//new DemoInfo(R.string.demo_title_overlay,
			//		R.string.demo_desc_overlay, ShouYi.class),
...
/*	private class DemoListAdapter extends BaseAdapter {
		...
		public View getView(int index, View convertView, ViewGroup parent) {
			convertView = View.inflate(Map_Main.this,

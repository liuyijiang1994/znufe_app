package com.znufe.pullDownToRefresh;
...
import com.znufe.pullDownToRefresh.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener{
	...
	private void initHeaderViewAndFooterViewAndListView(Context context){
		...
		//RotateAnimation,旋转动画效果，0为旋转开始的角度，180为旋转结束的角度
		//relative_to_self表示变化点在中心
		...
		//mFooterLoadingView为progress bar控件
			...
			switch (msg.what) {
			   ...
			   //刷新中
				case WHAT_ON_REFRESH:{
					// 要清除掉箭头的动画，否则无法隐藏箭头，并显示progress bar
	...
	private void showFooterView(){
		if(mListView.getFooterViewsCount() == 0 && isFillScreenItem()){
			//addFooterView必须在setAdapter之前调用，否则会报异常,但是代价太大，需要优化

...
public class FavouriteItemDetail extends FragmentActivity
{
	...
	private void initView()
	{
		...
		collectBtn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v)
			{
				DbManager helper = new DbManager(FavouriteItemDetail.this, DbManager.DB_NAME, null, 1);
				final SQLiteDatabase db = helper.getWritableDatabase();
				//已收藏，取消收藏
				if(isFavorite)
				{
					collectBtn.setImageResource(favoIcons[0]);
					Toast.makeText(FavouriteItemDetail.this, "取消了收藏", Toast.LENGTH_SHORT).show();
				...
				else
				{
					...
					Toast.makeText(FavouriteItemDetail.this, "收藏成功!", Toast.LENGTH_SHORT)
							.show();
					FavoItemDbHelper

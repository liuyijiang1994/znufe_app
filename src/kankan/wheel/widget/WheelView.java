...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF061c4aa;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFdfdfdf;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x595a5c,
		0x00AAAAAA, 0x00AAAAAA };//0x595a5c
